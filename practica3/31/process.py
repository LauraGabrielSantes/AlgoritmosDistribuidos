...
class Process:                   # Descendiente de la clase "object" (default)
    ...
    def setModel(self, model): #esta funcion se invoca desde simulation en la linea process.setModel(model) aqui se hace la asociación real
    ...
    def transmit(self, event):	
        ...
        self.engine.insertEvent(event) #Recordar que insertEvent es de Simulator
