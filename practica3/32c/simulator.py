...
class Simulator:                   # Descendiente de la clase "object" (default)
    ...
    def returnEvent(self):
        ...
        item = self.agenda.pop(1) #el elemento 0 de la agenda es fijo y no se toma en cuenta
        return item[1] #devuelve únicamente el evento

    def isOn(self):
        """ Verdadero si aun hay eventos que procesar """
        return len(self.agenda)>2 #recordar que la agenda tiene 2 centinelas fijas.
